...
from combat.enchantments.enchantments import MagDamageProc
...
class MagDamageProcHandler(EnchantmentEffectHandler):

    def __init__(self, controller: Controller):
        EnchantmentEffectHandler.__init__(
            self, controller=controller, enchantment=MagDamageProc()
        )
    ...
    async def is_penalty(
        ...
        return skill_effect == SkillEffect.PHYSICAL_DAMAGE
